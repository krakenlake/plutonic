							...
							unsigned long hart_mask_base)
{
	return sbicall(hart_mask, hart_mask_base, 0, 0, 0, 0,
		FID_sbi_remote_fence_i, EID_RFENCE);
}
							...
							unsigned long size)
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, 0, 0, 
		FID_sbi_remote_sfence_vma, EID_RFENCE);
}
							...
							unsigned long asid)
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, asid, 0, 
		FID_sbi_remote_sfence_vma_asid, EID_RFENCE);
}
							...
							unsigned long vmid)
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, vmid, 0, 
		FID_sbi_remote_hfence_gvma_vmid, EID_RFENCE);
}
...
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, 0, 0, 
		FID_sbi_remote_hfence_gvma, EID_RFENCE);
}
...
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, asid, 0, 
		FID_sbi_remote_hfence_vvma_asid, EID_RFENCE);
}
...
{
	return sbicall(hart_mask, hart_mask_base, start_addr, size, 0, 0, 
		FID_sbi_remote_hfence_vvma, EID_RFENCE);
}
